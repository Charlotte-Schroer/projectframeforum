                    ...
                    <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                New image <span class="text-gray-500 text-xs">(optional)</span>
                            </label>
                            ...
                            <div id="imagePreview" class="mt-4 hidden">
                                ...
                                <img id="preview" src="" alt="Preview"
                                    class="max-w-sm h-48 object-cover rounded-lg border-2 border-indigo-500">
                            </div>
                        </div>
                        ...
                        <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span
                                        class="ml-2 text-gray-900 dark:text-white font-medium">{{ $news->user->username }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500 dark:text-gray-400">Created:</span>
                                    <span
                                        class="ml-2 text-gray-900 dark:text-white">{{ $news->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500 dark:text-gray-400">Last edit:</span>
                                    <span
                                        class="ml-2 text-gray-900 dark:text-white">{{ $news->updated_at->format('d/m/Y H:i') }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500 dark:text-gray-400">Status:</span>
                                    @if($news->publication_date->isFuture())
                                        <span
                                            class="ml-2 px-2 py-0.5 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200">
                                            Planned
                                        </span>
                                    @else
                                        <span
                                            class="ml-2 px-2 py-0.5 text-xs font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                                            Published
                                        </span>
                                    @endif
                                </div>
